    ...
    while (true) {
      try {
        ...
        if (line.equals("end")) {
          ...
          String opcao = "";
          float valor = 0;
          System.out.println("Vc já possui uma conta?");
          ...
          receita.addReceita(new Receitas(conta, valor,Descricao,tipo,dataR,dataRE));
            ...
            String tipo = scanner.nextLine();
            System.out.printf("Digite a instituição fincanceira: ");
          ...
          System.out.printf("Insira o indice da conta que retirará o valor: ");
          int sai = scanner.nextInt();
          System.out.printf("Insira o indice da conta que receberá o valor: ");
